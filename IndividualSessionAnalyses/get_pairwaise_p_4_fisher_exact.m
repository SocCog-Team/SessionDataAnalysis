function [ pairwaise_P_matrix, pairwise_P_matrix_with_chance, P_data_not_chance_list ] = get_pairwise_p_4_fisher_exact( contingency_table, outcomes_by_chance_ratios)
