...
ConfederateSMCuriusLast4.setName = 'Confederate Curius Last4';
ConfederateSMCuriusLast4.setLabel = 'ConfederateSMCuriusLast4';
ConfederateSMCuriusLast4.label = {'Confederate', 'trained', 'Curius'};
ConfederateSMCuriusLast4.filenames = {...
	'DATA_20180111T130920.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180112T103626.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180118T120304.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180423T162330.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
	};
ConfederateSMCuriusLast4.Captions = {...
	'80111', ...
	'80112', ...
	'80118', ...
	'80423', ...
	};
ConfederateSMCuriusLast4.color = [192 157 169]/255;
ConfederateSMCuriusLast4.Symbol = 'none';
ConfederateSMCuriusLast4.FilledSymbols = 1;




ConfederateSMCuriusFirst4.setName = 'Confederate Curius first4';
ConfederateSMCuriusFirst4.setLabel = 'ConfederateSMCuriusFirst4';
ConfederateSMCuriusFirst4.label = {'Confederate', 'trained', 'Curius'};
ConfederateSMCuriusFirst4.filenames = {...
	'DATA_20171206T141710.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20171208T140548.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20171211T110911.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20171212T104819.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...
	};
ConfederateSMCuriusFirst4.Captions = {...
	'71206', ...
	'71208', ...
	'71211', ...
	'71212', ...
	};
ConfederateSMCuriusFirst4.color = [192 157 169]/255;
ConfederateSMCuriusFirst4.Symbol = 'none';
ConfederateSMCuriusFirst4.FilledSymbols = 1;
...
ConfederateCurius2.setName = 'Confederate Curius2';
ConfederateCurius2.setLabel = 'ConfederateCurius2';
ConfederateCurius2.label = {'Confederate', 'trained', 'Curius'};
ConfederateCurius2.filenames = {...
	...%'DATA_20180423T162330.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ... % last from initial set
	'DATA_20180625T130227.A_Curius.B_SM.SCP_01.triallog.A.Curius.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ... % the initial set went up to here on=off with NHP/NHP sessions interleaved
	'DATA_20180911T144201.A_Curius.B_AW.SCP_01.triallog.A.Curius.B.AW_IC_JointTrials.isOwnChoice_sideChoice', ... %  78 days later
	'DATA_20180912T141843.A_Curius.B_AW.SCP_01.triallog.A.Curius.B.AW_IC_JointTrials.isOwnChoice_sideChoice', ... % only two sessions
	... %'DATA_20190930T140425.A_Curius.B_RN.SCP_01.triallog.A.Curius.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ... % 12 month later only 9 trials
	'DATA_20191001T125313.A_Curius.B_RN.SCP_01.triallog.A.Curius.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ... % 384 days later, 12 month later
	... % 'DATA_20191007T102021.A_Curius.B_RN.SCP_01.triallog.A.Curius.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ... % only 2 dyadic trials
	... % 'DATA_20191008T100040.A_Curius.B_RN.SCP_01.triallog.A.Curius.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...
	... % 'DATA_20191009T092254.A_Curius.B_RN.SCP_01.triallog.A.Curius.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...
	... % 'DATA_20191010T093319.A_Curius.B_RN.SCP_01.triallog.A.Curius.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...
	... % 'DATA_20191011T111611.A_Curius.B_RN.SCP_01.triallog.A.Curius.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20191217T153148.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...	% last before christmas
	'DATA_20200108T152553.A_SM.B_Curius.SCP_01.triallog.A.SM.B.Curius_IC_JointTrials.isOwnChoice_sideChoice', ...	% 22 days first after christmas
	...% 'DATA_20200219T124153.A_Curius.B_SM.SCP_01.triallog.A.Curius.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ...	% last in  spring next is far off abd starts with diffGO training
	'DATA_20220729T110411.A_Curius.B_KN.SCP_01.triallog.A.Curius.B.KN_IC_JointTrials.isOwnChoice_sideChoice', ...	% last before summer break, diffGO
	'DATA_20220906T134024.A_Curius.B_SM.SCP_01.triallog.A.Curius.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ...	% 39 days later, first after summer break, diffGO
	}; % 
ConfederateCurius2.Captions = {...
	...%'180423B', ...
	'180625A', ...
	'180911A', ...
	'180912A', ...
...
ConfederateCurius2.color = [192 157 169]/255;
ConfederateCurius2.Symbol = 'none';
ConfederateCurius2.FilledSymbols = 1;
...
ConfederateSMFlaffusFirst4.setName = 'Confederate Flaffus First4';
ConfederateSMFlaffusFirst4.setLabel = 'ConfederateSMFlaffusFirst4';
ConfederateSMFlaffusFirst4.label = {'Confederate', 'trained', 'Flaffus'};
ConfederateSMFlaffusFirst4.filenames = {...
	'DATA_20180131T155005.A_SM.B_Flaffus.SCP_01.triallog.A.SM.B.Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180201T162341.A_SM.B_Flaffus.SCP_01.triallog.A.SM.B.Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180202T144348.A_SM.B_Flaffus.SCP_01.triallog.A.SM.B.Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180205T122214.A_SM.B_Flaffus.SCP_01.triallog.A.SM.B.Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
	};
ConfederateSMFlaffusFirst4.Captions = {...
	'80131', ...
	'80201', ...
	'80202', ...
	'80205', ...
	};
ConfederateSMFlaffusFirst4.color = [192 157 169]/255;
ConfederateSMFlaffusFirst4.Symbol = 'none';
ConfederateSMFlaffusFirst4.FilledSymbols = 1;



ConfederateSMFlaffusLast4.setName = 'Confederate Flaffus Last4';
ConfederateSMFlaffusLast4.setLabel = 'ConfederateSMFlaffusLast4';
ConfederateSMFlaffusLast4.label = {'Confederate', 'trained', 'Flaffus'};
ConfederateSMFlaffusLast4.filenames = {...
	'DATA_20180222T121106.A_SM.B_Flaffus.SCP_01.triallog.A.SM.B.Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180223T143339.A_SM.B_Flaffus.SCP_01.triallog.A.SM.B.Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180227T151756.A_SM.B_Flaffus.SCP_01.triallog.A.SM.B.Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20180228T132647.A_SM.B_Flaffus.SCP_01.triallog.A.SM.B.Flaffus_IC_JointTrials.isOwnChoice_sideChoice', ...
	};
ConfederateSMFlaffusLast4.Captions = {...
	'80222', ...
	'80223', ...
	'80227', ...
	'80228', ...
	};
ConfederateSMFlaffusLast4.color = [192 157 169]/255;
ConfederateSMFlaffusLast4.Symbol = 'none';
ConfederateSMFlaffusLast4.FilledSymbols = 1;
...
% '', ...
ConfederateElmoSM2.setName = 'Confederate Elmo SM2';
ConfederateElmoSM2.setLabel = 'ConfederateElmoSM2';
ConfederateElmoSM2.label = {'Elmo', 'confederate', 'SM_JK'};
ConfederateElmoSM2.filenames = {...
	...%'DATA_20190625T135240.A_Elmo.B_RN.SCP_01.triallog.A.Elmo.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...	% last old one
	'DATA_20190705T113649.A_Elmo.B_RN.SCP_01.triallog.A.Elmo.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...	% last
	'DATA_20190730T150228.A_Elmo.B_RN.SCP_01.triallog.A.Elmo.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...	% 25 days later, first after 3 weeks
	'DATA_20190926T130220.A_Elmo.B_RN.SCP_01.triallog.A.Elmo.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...	% last
	'DATA_20191114T110625.A_Elmo.B_RN.SCP_01.triallog.A.Elmo.B.RN_IC_JointTrials.isOwnChoice_sideChoice', ...	% 49 days ater, first after 6 weeks
	...%'DATA_20200219T143249.A_SM.B_Elmo.SCP_01.triallog.A.SM.B.Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...   % last
	...%'DATA_20200611T000001M.A_Elmo.B_SM.SCP_01.triallog.A.Elmo.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ...	% first (with diffGO) after 4 months
	...%'DATA_20200612T000001M.A_SM.B_Elmo.SCP_01.triallog.A.Elmo.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ... % EXCLUDE too few trials < 250
	...%'DATA_20200617T121709.A_SM.B_Elmo.SCP_01.triallog.A.SM.B.Elmo_IC_JointTrials.isOwnChoice_sideChoice', ... % next after 0612, decent following
	'DATA_20200724T142702.A_SM.B_Elmo.SCP_01.triallog.A.SM.B.Elmo_IC_JointTrials.isOwnChoice_sideChoice', ...	% last (with diffGO)
	'DATA_20200923T144403.A_Elmo.B_SM.SCP_01.triallog.A.Elmo.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ...	% 61 days later, first after 2 months (with diffGO)
	...%'DATA_20201028T132357.A_Elmo.B_SM.SCP_01.triallog.A.Elmo.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ...	% 2nd to last sessions before surgey (with diffGO)
	'DATA_20201030T162502.A_Elmo.B_SM.SCP_01.triallog.A.Elmo.B.SM_IC_JointTrials.isOwnChoice_sideChoice', ...	% last sessions before surgey (with diffGO)
	'DATA_20201202T142957.A_Elmo.B_FS.SCP_01.triallog.A.Elmo.B.FS_IC_JointTrials.isOwnChoice_sideChoice', ...	% 33 days later, 1. dyadic session after surgery (with diffGO)
	}; % 25, 49, 61, 33
ConfederateElmoSM2.Captions = {...
	...%'190625A', ...
	'190705A', ...
	'190730A', ...
	'190926A', ...
	...
	...%'200219B', ...
	...%'200611A', ...
	...%'200612A', ... % EXCLUDE too few trials < 250
	...%'200617A', ...
	'200724B', ...
	'200923A', ...
	...%'201028A', ...
...
ConfederateElmoSM2.color = [192 157 169]/255;
ConfederateElmoSM2.Symbol = 'none';
ConfederateElmoSM2.FilledSymbols = 1;
...
%   DATA_20190415T151442.A_190415ID101S1.B_190415ID102S1.SCP_01.triallog.A.190415ID101S1.B.190415ID102S1_IC_JointTrials.isOwnChoice_sideChoice, subject 101 aborted after ~97 joint trials
%
HumansTransparentToan.setName = 'HumansToan';
HumansTransparentToan.setLabel = 'HumansTransparentToan';
HumansTransparentToan.label = {'HumansToan', '', ''};
HumansTransparentToan.filenames = {...
	'DATA_20171115T165545.A_20013.B_10014.SCP_01.triallog.A.20013.B.10014_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20171116T164137.A_20015.B_10016.SCP_01.triallog.A.20015.B.10016_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20171121T165717.A_10018.B_20017.SCP_01.triallog.A.10018.B.20017_IC_JointTrials.isOwnChoice_sideChoice', ...
	'DATA_20171123T165158.A_20019.B_10020.SCP_01.triallog.A.20019.B.10020_IC_JointTrials.isOwnChoice_sideChoice', ...
...
HumansTransparentToan.Captions = {...
	'01_30', ...
	'02_31', ...
	'03_32', ...
	'04_33', ...
...
HumansTransparentToan.color = HumanColor;
HumansTransparentToan.Symbol = 's';
HumansTransparentToan.FilledSymbols = 1;
...
%   DATA_20190415T151442.A_190415ID101S1.B_190415ID102S1.SCP_01.triallog.A.190415ID101S1.B.190415ID102S1_IC_JointTrials.isOwnChoice_sideChoice, subject 101 aborted after ~97 joint trials
%
HumansTransparentSolo.setName = 'HumansTransparentSolo';
HumansTransparentSolo.setLabel = 'HumansTransparentSolo';
HumansTransparentSolo.label = {'HumansTransparentSolo', '', ''};
HumansTransparentSolo.filenames = {...
	'20200520T151327.A_None.B_20200520ID003S1.SCP_01.triallog.txt', ...
	'20200520T155351.A_20200520ID004S1.B_None.SCP_01.triallog.txt', ...
	'20200519T122227.A_None.B_20200519ID001S1.SCP_01.triallog.txt', ...
	'20200519T125308.A_20200519ID002S1.B_None.SCP_01.triallog.txt', ...
	};
HumansTransparentSolo.Captions = {...
	'01_30', ...
	'02_31', ...
	'03_32', ...
	'04_33', ...
...
HumansTransparentSolo.color = HumanColor;
HumansTransparentSolo.Symbol = 's';
HumansTransparentSolo.FilledSymbols = 1;
...
switch group_collection_name
	...
	case {'BoS_human_monkey_Toan'}	
		group_struct_list = {HumansTransparent, Macaques_late, Macaques_early, ConfederateTrainedMacaques,...
			HumansTransparentv6, HumansTransparentToan};

	case {'ConfederateCurius2'}	
		group_struct_list = {ConfederateCurius2};
...
% 			ConfederateTeslaSM};
		...
		group_struct_list = { ...
			HumansTransparent, Macaques_late, Macaques_early, ...
			ConfederatesMacaques_early, ConfederatesMacaques_late, ConfederateTrainedMacaques, ...
			ConfederateSMCurius, ConfederateSMCuriusBlocked, ...
			ConfederateSMFlaffus, ConfederateSMFlaffusBlocked, ...
			ConfederateElmoSM, ConfederateElmoSMBlocked, ...
			...
			CuriusElmoNaive, ConfederateTrainedElmoCurius, ...
			TeslaFlaffusNaive, TeslaCuriusNaive, TeslaElmoNaive, MagnusCuriusNaive, MagnusFlaffusNaive, ...
			HumansTransparentv6, HumansTransparentToan, HumansOpaque...
			ConfederateElmoSM2, ConfederateCurius2, ...
			ConfederateSMCuriusFirst4, ConfederateSMCuriusLast4, ConfederateSMFlaffusLast4, ConfederateSMFlaffusFirst4};

		%group_struct_list = { ConfederateCurius2 };
		
% 		group_struct_list = { HumansTransparent, Macaques_late, Macaques_early, ...
% 			ConfederateSMCurius, ...
% 			ConfederateSMFlaffus, ...
% 			ConfederateElmoSM, ...
% 			FlaffusCuriusNaive, ConfederateTrainedFlaffusCurius, ...
% 			HumansTransparentToan, ...
% 			ConfederateCurius2 };
...
for i_group = 1 : length(group_struct_list)
	...
	for i_file = 1 : length(current_coordcheck_filename_list)
		...
		cur_cc_prefix_string = cc_prefix_string;
		if isempty(prefix_idx) && fn_is_string_valid_datestring(current_coordcheck_filename(1:15), 'yyyyMMdd''T''HHmmss')
			% also allow true session IDs with YYYYMMDDTHHMMSS
			% t = datetime(current_coordcheck_filename(1:15), 'InputFormat', 'yyyyMMdd''T''HHmmss')
			% problem datetime does not properly return if the conversion fails
			prefix_idx = 1;
			cur_cc_prefix_string = [];
		end
		
		if ~isempty(prefix_idx)
			sessionID_start_idx = prefix_idx + length(cur_cc_prefix_string);
			...
			error(['Did not find the expected file prefix: ', cur_cc_prefix_string, ' in: ', current_coordcheck_filename]);
		end
	end
end
...
function [input_is_datestring] = fn_is_string_valid_datestring(input_string, input_format_specifier)

input_is_datestring = 0;

try
	t = datetime(input_string, 'InputFormat', input_format_specifier);
	input_is_datestring = 1;
catch
	% datestring errored out, so the input_string is not valid, that is all
	% we wanted to know
	input_is_datestring = 0;
end
return
