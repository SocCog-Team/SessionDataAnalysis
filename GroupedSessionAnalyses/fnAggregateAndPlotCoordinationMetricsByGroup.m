...
if (copy_plots_to_outdir_by_group)
	for i_group = 1 : length(group_struct_list)
		...
		for i_stem = 1 : length(current_session_id_list)
			...
			if (copy_is_move)
				[status, message] = movefile(fullfile(InputPath, 'CoordinationCheck', [current_session_id_list{i_stem}, '.mat']), [outdir, filesep]);
			else
...
% 			FlaffusCuriusNaive, ConfederateElmoSM, ConfederateTNLinus, Humans50_55__80_20, Humans50_50, GoodHumans, BadHumans, ConfederateElmoSMBlocked, ConfederateRNLinusBlocked};
% 	otherwise
